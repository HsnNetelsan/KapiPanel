...
//            this.loopback = loopback;
    ...
    public void createPeerConnection(final VideoSink localRender, final VideoSink remoteSink, final VideoCapturer videoCapturer, final AppRTCClient.SignalingParameters signalingParameters) {
    ...
    private void createMediaConstraintsInternal() {
        ...
        sdpMediaConstraints.mandatory.add(new MediaConstraints.KeyValuePair("googCpuOveruseDetection", "false"));//bunu mutlaka dene. cpu hızına göre görüntüyü düşürmeyi engelliyor olması lazım
    }
...
//        rtcConfig.enableDtlsSrtp = ! peerConnectionParameters.loopback;
    ...
    private File createRtcEventLogOutputFile() {
        ...
        try {
            Command commandForDelete = new Command(0, "rm -r /data/data/com.netelsan.ipinterkompanel/app_rtc_event_log/event_log.txt");
        ...
        // final String outputFileName = "event_log_" + dateFormat.format(date) + ".txt";
        final String outputFileName = "event_log" + ".txt";
        Log.d("HK", "HK getdir: " + appContext.getDir(RTCEVENTLOG_OUTPUT_DIR_NAME, Context.MODE_PRIVATE));
