...
//
////    private final List<CaptureFormat> formats = Arrays.asList(new CaptureFormat(1600, 1200, 0, 30000));
//
...
//
//    public CaptureQualityController(CallFragment.OnCallEvents callEvents) {
...
////        Log.d(Constants.LOG_TAG, "onProgressChanged targetBandwidth=" + targetBandwidth + " width=" + width + " height=" + height + " framerate=" + framerate);
//
